package org.project.kotlinjwtproject.common.exception
...
class CustomExceptionHandler {
    ...
    protected fun methodArgumentNotValidException(ex: MethodArgumentNotValidException): ResponseEntity<BaseResponse<Map<String, String>>> {
        ...
        return ResponseEntity(BaseResponse(ResultCode.ERROR.name, errors, ResultCode.ERROR.code), HttpStatus.BAD_REQUEST)
    }
